---
title: "Practice: Vector Introduction"
---
...
Write a function that returns a vector that excludes all elements equal to
...
any of the elements in a vector. 
...
only the elements equal to any of the elements in the specified vector.
...
valid modification is changing an existing number to a different number.
...
```{r}
restrict_to_bounds <- function(v, min, max) {
  # Your code here
}
```
